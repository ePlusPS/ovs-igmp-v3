...
struct flow {
    ...
    ovs_be16 igmp_mode;         /* Used for IGMPv3 membership mode */
    uint32_t igmp_rec_idx;      /* House keeping index */
};
...
BUILD_ASSERT_DECL(offsetof(struct flow, igmp_rec_idx) + sizeof(uint32_t)
